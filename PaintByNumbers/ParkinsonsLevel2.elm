...
stencilsToColour =
  [ (circle 10, move (-75,37), yellowBrush)
  , (triangle 40, move (-30,0) << rotate (degrees 90), sandBrush)
  , (triangle 40, move (10,0) << rotate (degrees 90), sandBrush)
  , (triangle 40, move (50,0) << rotate (degrees 90), sandBrush)
  , (rect 10 50, move (80,-20), brownBrush) 
  , (circle 20, move (80,20), greenBrush)
  , (circle 2, makeTransparent 0.1, blueBrush)
  , (circle 2, makeTransparent 0.1, brown2Brush)
  ]  
