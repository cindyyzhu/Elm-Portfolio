module WinterHolidayCodeFest.Crabby exposing (..)
...
completeCrab = group [
  crab
    ...
    , rightPincerLeftSide
         |> scale 0.5
    , rightPincerRightSide
         |> scale 0.5
 ]

leftPincerLeftSide = group [
