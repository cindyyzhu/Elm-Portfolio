...
script = [
  (Robot, "There is a lot of cleared space in the backyard that wasn’t there before. Maybe Addy")
  , (Robot, "is using this for her New Year’s resolution")
 ]
...
snowman model = group [
  ...
  , narrationBubble black (shantellSansFont) script 70 Robot model.time
      |> scale 1
      |> move (0,-40)
 ]
