...
type Actor = Mermaid | Pixar | Cody | Cloonie | Nar | Either | Or
...
repeatDuration duration start end t =
  start + (end - start) * fractionalModBy duration t / duration
...
myShapes model =
    case model.state of
        Welcome showInstructions ->
            ...
            -- text
            , [ multiBubbleRight black welcomeScript 42 Mermaid (4.5)--(model.time - model.startTime)
                  |> move(-10, 16)
                  |> scale 1.7
        ...
        Scene1  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene1Script = pixarScript ++ codyScript ++ mermaidScript 
                              ++ eitherScript ++ orScript
            pixarScript = [ (Pixar, "Hey guys! It's been 5 years")
                           , (Pixar, "since we met in Kindergarten!") 
                           , (Pixar, " ")
                           , (Pixar, "I think for today, we should")
                           , (Pixar, "do something special...")
                           ]
            codyScript = [ (Cody, "OH! I know!")
                         , (Cody, " ")
                         , (Cody, "Why don't we build")
                         , (Cody, "a statue out of pearls")
                         , (Cody, "to celebrate?")
                         ]
            mermaidScript = [ (Mermaid, "Hmm, what do you think, Cloonie?") ]
            eitherScript = [ (Either, "Ummm...")
        ...
        Scene2  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene2Script = pixar2Script ++ cody2Script ++ pixar2moreScript ++ mermaid2Script ++ either2Script ++ or2Script
            
            pixar2Script = [ (Pixar, "Then why don't we go and")
            ...
            pixar2moreScript = [(Pixar, "Come on! It'll be something") 
                           , (Pixar,"exciting for sure")]
                          
            mermaid2Script = [ (Mermaid, " Cloonie, what response")
                           , (Mermaid, "do you think will best")
                           , (Mermaid, "support Pixar and Cody?")]
                           
            either2Script = [(Either, "Nah,")
                           , (Either, "that sounds")
          ...
          in
            ...
            , group
                  [multiBubbleLeft textBlue
                     scene2Script 21 Either scriptTime 
                     |> move (47,0)
                  ]
                     |> move (-68, -40)
        ...
        Scene3  ->
          let
            ...
            scene3Script = mermaid3Script ++ pixar3Script ++ cody3Script ++ mermaid3twoScript ++ cody3twoScript ++ pixar3twoScript ++ mermaid3threeScript ++ either3Script ++ or3Script

            mermaid3Script = [(Mermaid, "*15 Minutes Later*")]
            
            pixar3Script = [(Pixar, "Let's split up and collect")
                            , (Pixar, "as many shells as we can!")]
             
            cody3Script = [(Cody, "Yeah!")]
              
            mermaid3twoScript = [(Mermaid, "*1 Hour Later*")]
              
            cody3twoScript = [(Cody, "Alright, let's check in everyone!")
             , (Cody, "these are all the seashells")
             , (Cody, "that we got! Why don't")
             , (Cody, "we try building three friends") 
             , (Cody,"hugging each other?")]
             
            pixar3twoScript = [(Pixar, "Yeah! Why don't we each make")
             , (Pixar, "check in often and at the")
             , (Pixar, "end, we should work together")
             , (Pixar, "to combine the three of them.")]
             
            mermaid3threeScript = [(Mermaid, "What do you think")
             , (Mermaid, "about that, Cloonie?")]
             
            either3Script = [(Either, "Ugh,")
             ,(Either, "you guys are")
             ,(Either, "so lame.")
             ,(Either, "Why do we")
             ,(Either, "even need")
          ...
          in
            ...
            , group
                  [multiBubbleLeft textBlue
                    scene3Script 20 Either scriptTime
                     |> move (47,0)
                  ]
                     |> move (-68, -40)
        ...
        Scene2End  ->
          ...
          in
            ...
            -- text
            , [ multiBubbleRight black failedEndScript 42 Mermaid (repeatDistance 1 20 1 model.time) --(model.time - model.startTime)
                  |> move(-10, 16)
                  |> scale 1.7
        ...
        Scene4  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene4Script = pixar4Script ++ mermaid4Script ++ pixar4twoScript
                          ++ mermaid4twoScript ++ pixar4threeScript ++ cody4Script
                          ++ pixar4fourScript ++ mermaid4threeScript ++ either4Script
                          ++ or4Script
                          
            pixar4Script = [(Pixar, "Hmm, I guess that works too.")]
            mermaid4Script = [(Nar, "30 minutes later")]
            pixar4twoScript = [(Pixar, "Good job guys! I think we") 
                           , (Pixar, "can put them together now.")]
            mermaid4twoScript = [(Nar, "*After they're put together*")]
            pixar4threeScript = [(Pixar, "Oh no! These figures")
                           , (Pixar, "are all different sizes and they")
                           , (Pixar, "don't look like they're hugging.")]
                           
            cody4Script = [(Cody, "we try building three friends") 
                           , (Cody,"hugging each other?")]
                           
            pixar4fourScript = [(Pixar, "Yeah! Why don't we each make")
                           , (Pixar, "check in often and at the")
                           , (Pixar, "end, we should work together")
                           , (Pixar, "to combine the three of them.")]
                           
            mermaid4threeScript = [(Mermaid, "What do you think")
                           , (Mermaid, "about that, Cloonie?")]
                           
            either4Script = [(Either, "Just put")
                           , (Either, "them besides")
                           , (Either, "each other.")
                           , (Either, "They don't")
                           , (Either, "need to be")
          ...
          in
            ...
            , group
                  [multiBubbleLeft textBlue
                    scene4Script 20 Either scriptTime
                     |> move (47,0)
                  ]
                     |> move (-68, -40)
        ...
        Scene5  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene5Script = mermaid5Script ++ pixar5Script ++ mermaid5twoScript
                          ++ pixar5twoScript ++ cody5Script ++ either5Script
            mermaid5Script = [(Mermaid, "And so, each of the three friends")
          ...
          in
            ...
            , group
                  [ multiBubbleLeft textBlue
                    scene5Script 20 Either scriptTime
                     |> move (47,0)
                  ]
                     |> move (-20, -40)
        ...
        Scene4End  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene4EndScript = [failedEndScript]
          in        
        ...
        Scene4half  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            scene4halfScript = pixar4halfScript 
            pixar4halfScript = [ (Pixar, "That's fine, Cloonie.")
        ...
        SceneEnd  ->
          let
            scriptTime = debugSpeedup*(model.time - model.startTime)
            sceneEndScript = [(Mermaid, "Whew, thanks Cloonie!")
...
headline txt = text txt  |> size 10 
                      |> centered |> sansserif |> filled (rgb 0 100 150)
                      |> addOutline (solid 0.5) (rgb 50 155 255)
                      

textSpeed = 1.85
bubbleClr = rgba 255 255 255 0.85
textHeight = 4
...
multiBubbleLeft textClr script width actor t =
  let
    ...
    (contents,visibility) = mkScriptFor textClr actor script (width/15)
  ...
  in
    scale 2 <| group <|
      if isVisible then
        ...
        , contents |> move (1 - 0.5*width,textSpeed * t)
...
mkScriptFor textClr actor theScript offset =
  let
      mkTxt idx txt = text txt |> size 2 |> fixedwidth |> filled textClr |> move (offset,-textHeight * idx)
...
buttonGreen = rgb 20 180 170
buttonHighlight t = rgba 255 255 170 (0.5+0.5*sin (2*t))
restartButton t =
  [ roundedRect 20 7 3
...
addTurtle (x,y) (u,v) = (x+u,y+v)
subTurtle (x,y) (u,v) = (x-u,y-v)
scaleTurtle s (x,y) = (s*x,s*y)
...
addPull (Pull p0 p1) (Pull p2 p3) = Pull (addTurtle p0 p2) (addTurtle p1 p3)
subPull (Pull p0 p1) (Pull p2 p3) = Pull (subTurtle p0 p2) (subTurtle p1 p3)
scalePull s (Pull p2 p3) = Pull (scaleTurtle s p2) (scaleTurtle s p3)
...
backgroundElements brightness schoolOfFish model = group [
            water brightness
            , schoolOfFish model
            , turtle model
              |> scale 0.3
            ...
            , let
                seaweed idx rawThickness =  
                  let 
                    thickness = 2 + rawThickness
                    spotHeight = sin (17 * toFloat idx)
                    spotRot = -1 * cos (17 * toFloat idx)
                    waveTime = model.time + 0.1 * toFloat idx
                    wholeSeaweed = curve (-thickness,-50)
                  ...
                  in
                  [ wholeSeaweed
                  , oval 3 7 |> filled (hsl (degrees 59) 0.437 0.463)
            ...
            -- sand  
            , oval 500 100 
            |> filled (gradient [stop (hsl (degrees 43) 0.53 0.61) 0
...
fishAni model = group
  ...
  ,
  fishBackground |> scale 0.8 |> mirrorX
  |> move (repeatDuration -10 23 105 model.time,0)
  ,
  fishBackground |> scale 0.6
  |> move (repeatDuration 7 35 -120 model.time,10)
  ,
  fishBackground |> scale 0.6 |> mirrorX
...
fishBackground = group
  [
  oval 15 10
  |> filled (hsl (degrees 226) 0.20 0.55)
  ,
  triangle 5
  |> filled (hsl (degrees 226) 0.20 0.55)
  |> move (-8,0)
...
-}
jellyfish color = group [ tentacles color,
...
yellowCoralTotal coralColour num = group [
  yellowCoral coralColour num
   ] 

yellowCoral coralColour size = (polygon [(0.25*size, size*0.5),(0.25*size,0.5*size),
   (0.25*size, 2.5*size),(0.25*size,4.5*size),(0, 5.5*size),
   (-0.25*size,4.5*size),(-0.25*size, 3.5*size), (-0.25*size,0.5*size), 
   (-0.25*size, size*0.5)]
    |> filled coralColour--(rgb (80*size+200) (80*size+200) 0)
    |> scaleY 1.4) 
    :: (if size > 0.5 then
...
sandGradient x0 x1
  = (gradient [stop (hsl (degrees 26) 0.93 0.25) x0
                     , stop (hsl (degrees 42) 0.5 0.75) x1]
                  |> rotateGradient (degrees 33))
-- parrotfish
parrotFishS model = group
  [
  oval 40 17 -- top fin
...
eyeShellS = curve (24.284,-35.28) [Pull (25.325,-36.84) (23.566,-37.20),Pull (22.387,-37.00) (22.609,-34.81),Pull (23.225,-33.33) (25.241,-33.85),Pull (27.858,-35.74) (26.676,-38.63),Pull (25.044,-41.27) (21.413,-40.31),Pull (15.375,-37.47) (19.738,-30.02),Pull (24.119,-24.62) (31.700,-30.02),Pull (36.857,-34.98) (33.614,-41.74),Pull (28.401,-50.80) (16.388,-44.85),Pull (8.2514,-34.27) (14.714,-25.48),Pull (23.201,-16.40) (35.289,-20.93),Pull (45.692,-25.58) (46.295,-38.63),Pull (48.156,-41.03) (45.816,-43.42),Pull (38.041,-49.44) (30.265,-46.05)
...
mouthShellS = 
  [
    curve (10.791,1.6487) [Pull (9.4861,11.990) (24.580,22.332),Pull (30.775,26.430) (38.370,28.327),Pull (41.968,29.028) (42.566,25.929),Pull (42.571,17.935) (29.976,10.941),Pull (24.230,7.4941) (20.084,4.0468),Pull (15.437,1.7978) (10.791,1.6487)]
    |> filled (rgb 117 131 174)
    |> addOutline (solid 0.5) (rgb 53 50 98)
    |> rotate (degrees -15)
    
    , 
    curve (19.784,3.4473) [Pull (30.725,5.2967) (43.466,4.9461),Pull (47.512,4.9964) (51.559,4.0468),Pull (53.161,2.4482) (46.763,0.4496),Pull (36.222,-2.499) (23.681,-2.248),Pull (16.086,-1.748) (11.690,-0.449),Pull (10.191,0.4496) (11.091,1.3489),Pull (15.288,2.3981) (19.784,3.4473)]
    |> filled (rgb 117 131 174)
    |> addOutline (solid 0.5) (rgb 53 50 98)
    |> rotate (degrees -10)
    ...
    , 
    curve (13.189,10.042) [Pull (27.633,14.936) (30.276,25.030)]
    |> outlined (solid 0.25) (rgb 53 50 98)
        |> rotate (degrees -15)

    , 
    curve (34.173,26.529) [Pull (33.825,20.533) (27.878,14.538),Pull (22.782,9.5908) (16.487,8.8430),Pull (13.438,8.2435) (11.990,7.6440)]
    |> outlined (solid 0.25) (rgb 53 50 98)
    |> rotate (degrees -15)

    , 
    curve (10.791,4.3466) [Pull (23.182,6.2918) (33.573,16.637),Pull (38.872,22.182) (37.170,27.728)]
    ...
    , 
    curve (23.381,4.0468) [Pull (25.929,2.8470) (30.276,3.4473),Pull (33.124,3.9468) (34.772,4.6463)]
    |> outlined (solid 0.5) (rgb 53 50 98)
        |> rotate (degrees -10)
...
fishTailS colour = group [
  curve (-7.044,-32.52) [Pull (-4.646,-30.10) (-2.248,-29.52),Pull (-3.896,-33.61) (-5.545,-34.62),Pull (-3.666,-35.85) (-3.147,-39.11),Pull (-5.096,-39.52) (-7.044,-38.22),Pull (-7.194,-36.42) (-7.344,-34.62),Pull (-7.644,-33.57) (-7.044,-32.52)]
    |> filled colour
  ]
  
leftFinS colour  = group [
...
upperFinS colour = group [
  curve (-26.82,-26.52) [Pull (-26.67,-24.28) (-26.52,-22.03),Pull (-24.88,-21.04) (-23.23,-21.13),Pull (-23.08,-22.03) (-22.93,-22.93),Pull (-22.48,-22.18) (-22.03,-21.43),Pull (-19.78,-20.47) (-17.53,-20.83),Pull (-17.53,-21.88) (-17.53,-22.93),Pull (-16.78,-22.18) (-16.03,-21.43),Pull (-13.48,-21.57) (-10.94,-24.43),Pull (-9.182,-27.30) (-9.142,-29.82),Pull (-11.54,-26.97) (-13.93,-25.92),Pull (-17.38,-24.37) (-20.83,-24.73),Pull (-23.83,-25.01) (-26.82,-26.52)]
  |> filled colour
  ]
...
fishTail colour = group [
  curve (-7.044,-32.52) [Pull (-4.646,-30.10) (-2.248,-29.52),Pull (-3.896,-33.61) (-5.545,-34.62),Pull (-3.666,-35.85) (-3.147,-39.11),Pull (-5.096,-39.52) (-7.044,-38.22),Pull (-7.194,-36.42) (-7.344,-34.62),Pull (-7.644,-33.57) (-7.044,-32.52)]
    |> filled colour
  ]
  
leftFin colour  = group [
  curve (-32.82,-38.22) [Pull (-34.17,-38.81) (-35.52,-39.41),Pull (-35.07,-40.16) (-34.62,-40.91),Pull (-34.02,-40.61) (-33.42,-40.31),Pull (-33.27,-40.61) (-33.12,-40.91),Pull (-33.42,-41.36) (-33.72,-41.81),Pull (-32.93,-42.26) (-31.62,-42.71),Pull (-30.57,-43.16) (-32.82,-38.22)]
    |> filled colour
  ]
  
rightFin colour = group [
     curve (-11.54,-36.72) [Pull (-13.18,-39.41) (-14.83,-42.11),Pull (-13.93,-42.26) (-13.03,-42.41),Pull (-12.74,-41.96) (-12.44,-41.51),Pull (-12.14,-41.96) (-11.84,-42.41),Pull (-10.94,-42.55) (-10.04,-42.41),Pull (-8.992,-41.96) (-7.943,-41.51),Pull (-8.683,-40.16) (-11.54,-36.72)]
    |> filled colour
  ]
  
  
upperFin colour = group [
  curve (-26.82,-26.52) [Pull (-26.67,-24.28) (-26.52,-22.03),Pull (-24.88,-21.04) (-23.23,-21.13),Pull (-23.08,-22.03) (-22.93,-22.93),Pull (-22.48,-22.18) (-22.03,-21.43),Pull (-19.78,-20.47) (-17.53,-20.83),Pull (-17.53,-21.88) (-17.53,-22.93),Pull (-16.78,-22.18) (-16.03,-21.43),Pull (-13.48,-21.57) (-10.94,-24.43),Pull (-9.182,-27.30) (-9.142,-29.82),Pull (-11.54,-26.97) (-13.93,-25.92),Pull (-17.38,-24.37) (-20.83,-24.73),Pull (-23.83,-25.01) (-26.82,-26.52)]
  |> filled colour
  ]
...
stops t = 
  List.range 0 10 
    |> List.map ( 
        \ idx -> stop (hsl (3 + degrees 2 * toFloat idx) 1 0.5) 
        (5 * toFloat idx)
        )
        
myBlack = (rgb 39 120 230) -- outline of the seashell

shell textLabel notifyMsg = 
  -- the shell
    let 
      shellStencil = curve (-46.91,-5.845) [Pull (-50.34,-11.84) (-46.01,-17.83),Pull (-23.53,-33.17) (-1.049,-35.52),Pull (20.084,-31.83) (41.217,-19.63),Pull (46.216,-11.98) (43.615,-6.145),Pull (47.835,1.1091) (44.215,8.2435),Pull (41.817,11.572) (39.419,10.941),Pull (40.350,15.437) (37.320,19.934),Pull (34.653,23.612) (31.025,25.330),Pull (28.098,30.547) (23.531,33.124),Pull (19.873,33.964) (18.735,31.925),Pull (12.449,39.843) (7.0444,34.922),Pull (-0.978,42.132) (-10.04,35.222),Pull (-18.00,37.983) (-22.93,31.625),Pull (-29.47,35.438) (-34.62,24.131),Pull (-42.71,24.086) (-43.01,10.042),Pull (-52.16,7.5983) (-46.91,-5.845)]
    ...
    in
      group [
        shellStencil 
          |> filled ( gradient
                        (stops 0.4)
                        |> rotateGradient (degrees 90) -- comment this line out for a vertical animation
                    )

        -- shell bottom colour
        , curve (-24.43,-30.72) [Pull (-24.88,-33.87) (-25.33,-37.02),Pull (-15.47,-38.59) (-3.747,-36.72),Pull (8.8430,-39.10) (21.433,-38.51),Pull (21.863,-34.17) (20.533,-29.82),Pull (8.5433,-32.82) (-3.447,-35.82),Pull (-13.33,-32.82) (-23.23,-29.82),Pull (-23.83,-30.42) (-24.43,-30.72)]
        |> filled (
        ...
        -- bottom
        , curve (-24.43,-29.52) [Pull (-24.77,-33.74) (-25.03,-37.32),Pull (-18.27,-39.57) (-3.447,-37.02),Pull (12.513,-39.07) (20.833,-38.51),Pull (21.823,-34.32) (20.533,-30.12),Pull (7.9325,-34.42) (-1.348,-36.12),Pull (-11.62,-35.40) (-24.43,-29.52)]
        ...
        -- left curves 2 and 3
        , curve (-46.31,-5.845) [Pull (-52.85,6.9381) (-43.31,10.641),Pull (-40.32,-0.370) (-34.62,-9.742),Pull (-50.60,19.424) (-35.82,24.430),Pull (-34.92,24.701) (-34.02,24.131),Pull (-30.76,2.9068) (-21.43,-16.03)]
        |> outlined (solid 1) myBlack

        --left curves 3 4 5
        , curve (-34.62,25.030) [Pull (-28.73,35.697) (-22.93,31.925),Pull (-22.83,20.463) (-21.13,10.042),Pull (-27.27,42.932) (-10.34,35.222),Pull (-9.652,30.126) (-10.04,25.030),Pull (-9.892,29.976) (-9.742,34.922),Pull (-1.498,43.152) (6.7447,35.222),Pull (11.757,-5.209) (-1.348,-36.12),Pull (20.023,-16.69) (19.035,27.728)]
        |> outlined (solid 1) myBlack

        -- right curves
        , curve (7.0444,34.922) [Pull (13.479,40.294) (19.035,31.625),Pull (25.150,36.147) (30.426,25.030),Pull (30.169,7.6934) (22.032,-8.243),Pull (29.989,8.5433) (30.426,25.330),Pull (39.752,22.095) (39.119,12.740),Pull (38.241,5.6553) (34.922,-0.749),Pull (38.461,5.2459) (38.519,11.241),Pull (47.657,9.9866) (44.515,-2.548),Pull (37.802,-13.99) (25.929,-23.53),Pull (35.833,-15.58) (42.416,-5.845),Pull (44.295,-5.433) (44.814,-9.742),Pull (44.466,-15.75) (39.718,-19.93),Pull (29.606,-26.29) (19.934,-30.12),Pull (9.8922,-33.47) (-0.149,-35.22),Pull (18.197,-28.97) (31.625,-7.644)]
        |> outlined (solid 1) myBlack
        ...
        -- middle line
        , curve (-18.73,2.5480) [Pull (-15.60,-14.22) (-7.644,-28.92)]
        |> outlined (solid 1) myBlack
...
finalSadMermaid model = group [
  completeSadMermaid model
      |> move (0, 10*sin model.time*0.5)
  ]

completeSadMermaid model = group [
  tailSad model
      |> scale 0.5
      |> move (-68, -13)
